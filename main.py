...
@app.route('/ppt')
def ppt():
    return send_file('Assets\Project_Presentation.pptx', mimetype='application/vnd.openxmlformats-officedocument.presentationml.presentation', as_attachment=False)

@app.route("/demo_video")
def video():
    return send_file("Assets\Demo_Video.mp4", mimetype="video/mp4", as_attachment=False)
